	        	...
	        	<div id="page-wrap"">
					...
					<div id="front-slides">
						<div class="slides_container">
							...
							<div class="slide">
								<img src="../img/dummies/c2.jpg" alt="pic" width="940" height="360"  />
								
							</div>
							<div class="slide">
								<img src="../img/dummies/c3.jpg" alt="pic" width="940" height="360"  />
					...
					<img src="../img/cult-logo.png" class="hribbon" style="left:304px;">
				  </div></div>  
				  
					<pre id = "content" class="writeup" >
                 <img src="../img/quote.png" style="position: relative;top: 20px; left:51px;" >   
		
				When you stroll into the hostel, you can catch someone strumming a guitar,
				someone dancing and heads bent over a laptop editing a movie they just shot.
				Hostel 15 is a beehive of cult enthu junta. We believe that cultural 
				activities are essential in life. They add that extra zing and masti.  Which
				is why when a festival comes around; no expense is spared to make it the most
				memorable yet. For us fun and cult are synonymous.
       	             </pre>
                    <div class="clear"></div>
					<!-- ENDS Featured -->
