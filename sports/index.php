	        	...
	        	<div id="page-wrap"">
					...
					<div id="front-slides">
						<div class="slides_container">
							<div class="slide">
								<img src="../img/dummies/s1.jpg"  alt="pic" width="940" height="360"  />
								
							</div>
							<div class="slide">
								<img src="../img/dummies/s2.jpg" alt="pic" width="940" height="360"  />
								
							</div>
							<div class="slide">
								<img src="../img/dummies/s3.jpg" alt="pic" width="940" height="360"  />
					...
					<img src="../img/sports-logo.png" class="hribbon" style="left:252px;">
				  </div></div>  
				  
					<pre id = "content" class="writeup" >
                 <img src="../img/quote.png" style="position: relative;top: 20px; left:51px;" >   
		
				Duniya hiila denge ,sabko dikhadenge seems to currently be the motto of our
				H15 sports players. If there is a game to be played, a match to be won, then 
				that is what they will do. The dedication and the talent that they display on
				the field makes us proud. In Hostel 15 we play with our heart and soul.
